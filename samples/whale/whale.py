"""
Mask R-CNN
Train on the toy Whale dataset and implement color splash effect.
...
Usage: import the module (see Jupyter notebooks for examples), or run from
    ...
    python3 whale.py train --dataset=/path/to/whale/dataset --weights=coco
...
class WhaleConfig(Config):
    ...
    NUM_CLASSES = 1 + 1  # Background + whale
